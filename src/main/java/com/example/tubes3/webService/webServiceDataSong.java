...
public class webServiceDataSong {
    ...
    public static  void jsonParse() {
        ...
        urllist.add(url3);
        urllist.add(url4);
        gambar.add("https://upload.wikimedia.org/wikipedia/en/1/16/Wiz_Khalifa_Show_And_Prove.jpg");
        gambar.add("https://upload.wikimedia.org/wikipedia/en/thumb/6/63/SnoopDoggyDoggDoggystyle.jpg/220px-SnoopDoggyDoggDoggystyle.jpg");
        gambar.add("https://upload.wikimedia.org/wikipedia/en/thumb/5/57/Coldplayparachutesalbumcover.jpg/220px-Coldplayparachutesalbumcover.jpg");
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    if(artis.equals("Wiz Khalifa")) {
                                        addAlbum(artis, song.getString("title"), 0, 0, "", song.getString("first-release-date"), false, gambar.get(0));
                                        }
                                    else if(artis.equals("Snoop Dogg")){
                                        addAlbum(artis, song.getString("title"), 0, 0, "", song.getString("first-release-date"), false, gambar.get(1));

                                    }
                                    else if(artis.equals("Coldplay")){
                                        addAlbum(artis, song.getString("title"), 0, 0, "", song.getString("first-release-date"), false, gambar.get(2));
