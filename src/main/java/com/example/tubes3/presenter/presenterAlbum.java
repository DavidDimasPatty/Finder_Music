...
public class presenterAlbum {
    ...
    public static void addToList(String artis, String album,int rating,int listen,String desc,String release){
        alData.add(new albumdata( artis, album, rating, listen, desc, release));
    }
